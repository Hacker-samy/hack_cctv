...
print('\n')
print(green+'    HaCKer_Samy    ')
print('  esky = haram ×     ')
print('   cctv-_--_--__--_- dorbin_madarbaste     ')
print('    hack-cctv   ')
print('  hacker cctv    ')
print(' #irani ')
print('        𝕙𝕒𝕔𝕜𝕖𝕣-𝕤𝕒𝕞𝕪')
print('\n')
print(green+'%37s' % '   sazande : HaCkEr_sAmy ')
print(red+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print(blue+'rubika : @Amir_terol2022')
print(blue+'soroush : @hacka')
print(red+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
